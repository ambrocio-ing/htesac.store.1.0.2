...
@Component({
  selector: 'app-lista-resumen-pedidos-barranca',
  templateUrl: './lista-resumen-pedidos-barranca.component.html',
  styleUrls: ['./lista-resumen-pedidos-barranca.component.css']
})
export class ListaResumenPedidosBarrancaComponent implements OnInit {
