...
@Component({
  selector: 'app-lista-pedidos-huacho',
  templateUrl: './lista-pedidos-huacho.component.html',
  styleUrls: ['./lista-pedidos-huacho.component.css']
})
export class ListaPedidosHuachoComponent implements OnInit {
  ...
  changeStatusAnular(com: Comprobante): void {
    ...
    Swal.fire({
      icon: 'question',
      text: 'Seguro que desea cambiar estado a ANULADO???, ten en cuenta que el stock será restablecido, estos cambios no son reversibles',
      showCancelButton: true,
      confirmButtonText: 'Sí',
      cancelButtonText: 'No'
    }).then(res => {
