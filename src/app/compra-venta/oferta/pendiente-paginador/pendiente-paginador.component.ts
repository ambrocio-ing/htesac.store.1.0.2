...
@Component({
  selector: 'app-pendiente-paginador',
  templateUrl: './pendiente-paginador.component.html',
  styleUrls: ['./pendiente-paginador.component.css']
})
export class PendientePaginadorComponent implements OnInit, OnChanges {
  ...
  cambiarpagina(page:number) : void {
    if(this.tipo == "cliente"){
      this.ccservice.cbPendiente.emit(page);
    }
    else if(this.tipo == "proveedor"){
      this.poService.cbPendiente.emit(page);
    }
