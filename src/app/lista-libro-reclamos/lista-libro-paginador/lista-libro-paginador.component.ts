...
@Component({
  selector: 'app-lista-libro-paginador',
  templateUrl: './lista-libro-paginador.component.html',
  styleUrls: ['./lista-libro-paginador.component.css']
})
export class ListaLibroPaginadorComponent implements OnInit {
  ...
  cambiarpagina(page:number) : void {
    ...
    this.libroService.cbPaginar.emit(page);
